 ...
 * @subpackage Odr_Reference_Search/public/partials
 */

/*
    Variables available from admin settings (odr_reference_search_plugin_options):
    - datatype_id
    - general_search
    - mineral_name
    - reference_author (from author_names)
    - reference_title (from title)
    - reference_journal (from journal)
    - reference_year (from year)
    - redirect_url
    - cif (Reference Search Theme ID)
    - sort_mineral_name_field
    - sort_author_field
    - sort_title_field
    - sort_journal_field
    - sort_year_field
...
<script type="text/javascript">
    ...
    let datatype_id = "<?php echo $odr_reference_search_vars['datatype_id']; ?>";
    let general_search = "<?php echo $odr_reference_search_vars['general_search']; ?>";
    let mineral_name = "<?php echo $odr_reference_search_vars['mineral_name']; ?>";
    let reference_author = "<?php echo $odr_reference_search_vars['reference_author']; ?>";
    let reference_title = "<?php echo $odr_reference_search_vars['reference_title']; ?>";
    let reference_journal = "<?php echo $odr_reference_search_vars['reference_journal']; ?>";
    let reference_year = "<?php echo $odr_reference_search_vars['reference_year']; ?>";
    let redirect_url = "<?php echo $odr_reference_search_vars['redirect_url']; ?>";
    let cif = "<?php echo $odr_reference_search_vars['cif']; ?>";

    // Sort field IDs
    let sort_mineral_name_field = "<?php echo $odr_reference_search_vars['sort_mineral_name_field']; ?>";
    let sort_author_field = "<?php echo $odr_reference_search_vars['sort_author_field']; ?>";
    let sort_title_field = "<?php echo $odr_reference_search_vars['sort_title_field']; ?>";
    let sort_journal_field = "<?php echo $odr_reference_search_vars['sort_journal_field']; ?>";
    let sort_year_field = "<?php echo $odr_reference_search_vars['sort_year_field']; ?>";
</script>


<form id="reference-search-form-wrapper">
<div id="reference-search-form" class="sarch_form">
    <!-- Mineral field hidden for now
    <div class="pure-u-1">
        ...
        <div class="pure-u-1 pure-u-md-16-24 pure-u-xl-16-24">
            <div class="pure-u-10-24 pure-u-md-6-24 pure-u-xl-6-24">
                <select name="sel_sort" id="sel_sort" size="1" class="pure-u-1">
                    <option value="<?php echo $odr_reference_search_vars['sort_author_field']; ?>">Author</option>
                    <option value="<?php echo $odr_reference_search_vars['sort_title_field']; ?>">Title</option>
                    <option value="<?php echo $odr_reference_search_vars['sort_journal_field']; ?>">Journal</option>
                    <option value="<?php echo $odr_reference_search_vars['sort_year_field']; ?>">Year</option>
                </select>
            </div>
            <div class="pure-u-10-24 pure-u-md-6-24 pure-u-xl-6-24">
    ...
    <div class="reference-search-form-section pure-u-1">
        ...
        <div class="pure-u-1 pure-u-md-16-24 pure-u-xl-16-24">
            <input id="reference-search-form-submit" name="submit" type="button" value="search">&nbsp;
...
<div id="div_periodic_table" style="overflow: visible;">
    <div id="div_periodic_table_contents">
        <table id="reference-periodic-table">
            <tbody><tr>
    ...
    <table>
        <tr>
            <td colspan="4" class="AMCSDMineralAlpha">
                ...
                <span class="AMCSDCloseModal" onclick="referenceClearMineralNameList()">[ clear ]</span>
            </td>
        </tr>
        <?php
        try {
